...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.andrei_imp_facts1.setText('- Created global_test and global_predict functions')
        ...
        self.vova_imp_facts2.setText('- Help to create global_predict and global_test functions')
        ...
        self.valera_imp_facts3.setText('- Itroduced predict and test function to GUI')
    ...
    def button_predict_clicked(self):
        ...
        result = global_predict(modelsDir, self.dir_name)
        ...
        for i in range(len(result)):
            ...
            self.tableWidget.setItem(i, 1, QTableWidgetItem((str(result[i][1])[:6]) + "%"))
